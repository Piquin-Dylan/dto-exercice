...
mixin _$Category {
  ...
  String get id;
  String get title;
  String get description; // Exemple d'utilisation du converter timestamp
  ...
  @override
  String toString() {
    return 'Category(id: $id, title: $title, description: $description, createdAt: $createdAt)';
  }
}
...
extension CategoryPatterns on Category {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _Category() when $default != null:
        return $default(
            _that.id, _that.title, _that.description, _that.createdAt);
      case _:
        return orElse();
    }
  }
