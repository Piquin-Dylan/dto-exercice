...
mixin _$User {
  ...
  String get lastName;
  String get email; // Exemple d'utilisation du converter timestamp
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, firstName, lastName, email, createdAt);

  @override
  String toString() {
    return 'User(id: $id, firstName: $firstName, lastName: $lastName, email: $email, createdAt: $createdAt)';
  }
}
