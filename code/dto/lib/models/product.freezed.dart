...
mixin _$Product {
  ...
  String get price; // Exemple d'utilisation du converter timestamp
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, description, price, createdAt);

  @override
  String toString() {
    return 'Product(id: $id, name: $name, description: $description, price: $price, createdAt: $createdAt)';
  }
}
