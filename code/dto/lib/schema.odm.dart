...
final class _$ProductCollection {}
...
extension $AppSchemaUsersCategoriesTransactionDocument on TransactionDocument<
  ...
  /// Access product subcollection
  @pragma('vm:prefer-inline')
  TransactionCollection<AppSchema, Product,
          (_$UsersCollection, _$CategoriesCollection, _$ProductCollection)>
      get product => TransactionCollection<AppSchema, Product,
              (_$UsersCollection, _$CategoriesCollection, _$ProductCollection)>(
            query: ref.collection('product'),
            context: context,
...
extension $AppSchemaUsersCategoriesDocument on FirestoreDocument<AppSchema,
  ...
  /// Access product subcollection
  FirestoreCollection<AppSchema, Product,
          (_$UsersCollection, _$CategoriesCollection, _$ProductCollection)>
      get product => FirestoreCollection<AppSchema, Product,
              (_$UsersCollection, _$CategoriesCollection, _$ProductCollection)>(
            query: ref.collection('product'),
            converter: const _$ProductJsonConverter(),
            documentIdField: 'id',
...
extension $AppSchemaUsersCategoriesBatchDocument on BatchDocument<AppSchema,
  ...
  BatchCollection<AppSchema, Product,
          (_$UsersCollection, _$CategoriesCollection, _$ProductCollection)>
      get product => getBatchCollection(
            parent: this,
            name: 'product',
            converter: const _$ProductJsonConverter(),
            documentIdField: 'id',
